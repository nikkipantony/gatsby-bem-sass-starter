...
<Canvas>
    <div>
        <p>
            Examples of <i>idiomatic text</i> could include... <br />
            "She wondered, <i>What is this writer talking about, anyway?</i>" <br />
            or <br />
...
<Canvas>
    <div>
        <p>
            An example of a sentence that could use the
            <strong>strong</strong> element is... <br />
            "before proceeding, <strong> make sure you put 
            on your safety goggles</strong>."
        </p>
    </div>
</Canvas>
